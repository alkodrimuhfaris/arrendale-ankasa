...
const SearchDetail = () => {
  ...
  const onClickSearch = () => {
    ...
    if (!isSwitch) {
      dispatch(searchActions.findTicket(originId, destinationId, className, dateFlight, filterSearch));
    } else {
      dispatch(searchActions.findTicket(destinationId, originId, className, dateFlight, filterSearch));
    }
  };
  return (
